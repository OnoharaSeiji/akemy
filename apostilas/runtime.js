(() => {
  ...
  if (!cfg) {
    document.body.innerHTML = '<main style="font-family:Arial,sans-serif;padding:24px;color:#fff;background:#120d19;min-height:100vh">Erro ao carregar config.js</main>';
    return;
  }
  ...
  const styles = `
    :root{
      --bg:#0f0b16;--panel:#171122;--panel2:#211730;--line:rgba(255,255,255,.08);--text:#f7f2ff;
      --muted:#c8bfd8;--soft:#9e92b2;--rose:#c15c8a;--wine:#7b2f4f;--violet:#6d56c9;--blue:#295d8f;
      --gold:#d9a86c;--mint:#2f7b62;--shadow:0 24px 70px rgba(0,0,0,.35)
    }
    *{box-sizing:border-box} html{scroll-behavior:smooth}
    body{margin:0;font-family:Inter,Segoe UI,Arial,sans-serif;color:var(--text);background:
      radial-gradient(circle at 8% 10%, rgba(193,92,138,.15), transparent 25%),
      radial-gradient(circle at 92% 14%, rgba(109,86,201,.12), transparent 22%),
      radial-gradient(circle at 50% 100%, rgba(41,93,143,.12), transparent 30%),
      linear-gradient(180deg,#0f0b16 0%,#120d19 100%)}
    a{color:inherit}.page{width:min(1180px,calc(100% - 24px));margin:0 auto;padding:24px 0 52px}
    .hero,.section{background:linear-gradient(180deg,rgba(255,255,255,.04),rgba(255,255,255,.015));border:1px solid var(--line);border-radius:28px;box-shadow:var(--shadow)}
    .hero{padding:26px;position:relative;overflow:hidden}.hero:before,.hero:after{content:"";position:absolute;border-radius:50%;filter:blur(22px);opacity:.42}
    .hero:before{width:180px;height:180px;right:-30px;top:-30px;background:radial-gradient(circle,rgba(193,92,138,.62),transparent 70%)}
    .hero:after{width:220px;height:220px;left:-50px;bottom:-70px;background:radial-gradient(circle,rgba(41,93,143,.5),transparent 70%)}
    ...
    .pill{padding:8px 12px;background:rgba(255,255,255,.06);font-size:12px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:#f5d6ae}
    ...
    .btn-primary{background:linear-gradient(135deg,var(--rose),var(--wine));color:#fff;border-color:transparent}.btn-secondary{background:rgba(255,255,255,.05)}
    .hero-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:18px}.mini-card,.card,.quiz-card,.flow-card,.exercise,.video,.week-card{background:rgba(255,255,255,.05);border:1px solid var(--line);border-radius:22px;padding:18px}
    ...
    .poster{min-height:170px;padding:18px;border-radius:24px;position:relative;overflow:hidden;border:1px solid rgba(255,255,255,.08);display:flex;flex-direction:column;justify-content:flex-end}
    .poster:before{content:"";position:absolute;right:-20px;top:-18px;width:140px;height:140px;border-radius:50%;opacity:.34}.poster-rock{background:linear-gradient(160deg,rgba(123,47,79,.36),rgba(23,17,34,.95))}.poster-rock:before{background:radial-gradient(circle,rgba(217,168,108,.85),transparent 62%)}
    .poster-social{background:linear-gradient(160deg,rgba(41,93,143,.34),rgba(23,17,34,.95))}.poster-social:before{background:radial-gradient(circle,rgba(255,255,255,.7),transparent 62%)}
    .poster .mode-badge{position:absolute;top:16px;left:16px;padding:7px 10px;background:rgba(255,255,255,.08);font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#ffe4bf}
    ...
    .stack{display:grid;gap:18px;margin-top:18px}.section{padding:22px}.section-title{color:#f4c894;text-transform:uppercase;letter-spacing:.12em;font-size:12px;font-weight:800;margin-bottom:10px}
    ...
    .focus-box{padding:16px;border-radius:18px;background:rgba(255,255,255,.04);border:1px solid var(--line)}.focus-box strong{display:block;font-size:1rem;margin-bottom:8px}.focus-box p{color:var(--muted);line-height:1.65}
    .formula{margin-top:14px;padding:14px 16px;border-radius:18px;background:rgba(217,168,108,.1);border:1px solid rgba(217,168,108,.22);color:#ffe1be;line-height:1.68;font-weight:700}
    details{margin-top:12px;border-radius:16px;border:1px solid var(--line);background:rgba(255,255,255,.03);overflow:hidden}summary{cursor:pointer;list-style:none;padding:14px 16px;font-weight:800}summary::-webkit-details-marker{display:none}details div{padding:0 16px 16px;color:var(--muted);line-height:1.7}
    .quiz-wrap,.qa,.practice-list,.videos,.week-grid{display:grid;gap:14px;margin-top:16px}.chip-row{display:flex;gap:10px;flex-wrap:wrap;margin-top:12px}.chip{padding:8px 12px;background:rgba(255,255,255,.05);font-size:12px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:#f5d6ae}
    .flow{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:14px}.flow-card strong{display:block;margin-bottom:8px}.table-wrap{overflow:auto;margin-top:16px;border:1px solid var(--line);border-radius:18px}table{width:100%;min-width:560px;border-collapse:collapse;background:rgba(255,255,255,.03)}th,td{padding:14px 16px;text-align:left;border-bottom:1px solid var(--line);color:var(--muted);line-height:1.62}th{color:#ffe4bf;background:rgba(255,255,255,.04);font-size:12px;text-transform:uppercase;letter-spacing:.08em}
    .exercise strong,.video strong,.week-card strong{display:block;font-size:1rem;line-height:1.55;margin-bottom:8px}.video a{text-decoration:none}.nav{justify-content:space-between}.footer-note{margin-top:12px;color:var(--soft);font-size:.92rem;text-align:center}
